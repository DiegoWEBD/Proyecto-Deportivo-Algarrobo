...
function Inicio() {
    ...
    var mensaje = "Debido a la alta demanda en nuestro gimnasio, ya no ofrecemos clases individuales por día."
    $('#Error_ReservarHora').empty();
    $("#Error_ReservarHora").append('<div  class="alert alert-primary alert-dismissible fade show"  role="alert" ><strong> INFORMACIÓN: </strong>' + mensaje + ' <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>');
}
